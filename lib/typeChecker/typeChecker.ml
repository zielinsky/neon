...
and telescope_check_type (env : env) (telescope : ParserAst.telescope) : Ast.telescope =
  ...
  | Cons (nm, tp, ts) -> 
      ...
      res
and check_args_against_telescope (env : env) (args : ParserAst.uTerm list) (telescope : Ast.telescope) : term list =
